...
if(isDev) {
    ...
    blender.js('./src/Admin.js', './docs/venus-admin-ui.js')
        .sass('./src/Admin.scss', './docs/venus-admin-ui.css')
} else {
    ...
    blender.js('./src/Admin.js', './dist/venus-admin-ui.js')
        .sass('./src/Admin.scss', './dist/venus-admin-ui.css');
}